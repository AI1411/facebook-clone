<template>
    <div class="bg-white h-12 px-4 flex items-center border-b border-gray-400 shadow-sm">
        ...
        <div class="w-1/3 flex justify-center items-center h-full">
            <router-link :to="'/users/' + authUser.data.user_id" class="px-6 border-b-2 border-blue-500 h-full flex items-center ">
            ...
            <router-link to="/" class="px-6 border-b-2 border-white h-full flex items-center ">
                <img src="/img/978ac1e89199109775da54aae87299dc_600.jpg" alt="profile image for user" class="w-8 h-8 object-cover rounded-full">
            </router-link>
            <router-link to="/" class="px-6 border-b-2 border-white h-full flex items-center ">
